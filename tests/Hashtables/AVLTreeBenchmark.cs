...
{
    private AVLTreeDictionary<int, int> _customTree;
    private int[] _keys;
    ...
    public void Setup()
    {
        _customTree = new AVLTreeDictionary<int, int>();
        _keys = new int[N];
    ...
    [Benchmark]
    public void Benchmark_AVLTree_TryGetValue()
    {
    ...
    [Benchmark]
    public void Benchmark_AVLTree_Add()
    {
        var table = new AVLTreeDictionary<int, int>();
        foreach (var key in _keys)
        {
            table.Add(key, key);
        }
    ...
    [Benchmark]
    public void Benchmark_AVLTree_ContainsKey()
    {
        foreach (var key in _keys)
        {
    ...
    [Benchmark]
    public void Benchmark_AVLTree_AddRemove()
    {
        var table = new AVLTreeDictionary<int, int>();
        foreach (var key in _keys)
        {
